            ...
            <div className="lg:flex-row flex-col    lg:py-5   pt-16   lg:gap-10 gap-8 flex justify-between items-center">
                <div className=" flex-1">
                    ...
                    <div className="flex items-center gap-3">
                        <button className="bg-gradient-to-r from-blue-500 via-purple-500 to-pink-500  w-40 text-white rounded-md  py-2">
                           Manage Links
                        </button>
                        <button className="border-btnColor border w-40  bg-gradient-to-t from-red-500 via-indigo-500 to-teal-500 text-transparent bg-clip-text rounded-md  py-2 ">
                            Create Short Link
                        </button>
                    </div>
                </div>
