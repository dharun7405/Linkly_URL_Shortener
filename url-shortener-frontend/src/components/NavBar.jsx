...
const NavBar = () => {
    ...
    return (
        <div className="h-16 bg-gradient-to-r from-blue-500 to-pink-500 z-50 flex items-center sticky top-0">
            <div className="lg:px-14 sm:px-8 px-4 w-full flex justify-between">
                ...
                <ul className={`flex sm:gap-10 gap-4 sm:items-center sm:mt-1 sm:pt-0 pt-3 text-slate-800 sm:static absolute left-0 top-[62px] sm:shadow-none shadow-md ${
                    ...
                    }  transition-all duration-100 sm:h-fit sm:bg-none  bg-gradient-to-r from-blue-500 to-pink-500 sm:w-fit w-full sm:flex-row flex-col px-4 sm:px-0`}>
                    <li className="hover:text-indigo-500 font-[500] transition-all duration-150">
                        <Link
                            className={`${
                ...
                <button onClick={()=> setNavbarOpen(!navbarOpen)}
                    ...
                    {navbarOpen ? (<RxCross2 className="text-white text-3xl"/>)
